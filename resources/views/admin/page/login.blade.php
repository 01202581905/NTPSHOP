...
<html>
  <head>
    ...
    <title>Đăng Nhập Quản Lý Website | NTP-SHOP</title>
  ...
  <body class="hold-transition login-page">
      ...
      <div class="login-box-body">
        ...
        <form action="{{route('checkloginadmin')}}" method="post">
          ...
          <div class="form-group has-feedback">
            <input type="username" class="form-control" autocomplete="off" placeholder="tên tài khoản">
            <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
          </div>
          <div class="form-group has-feedback">
            <input type="password" autocomplete="off" class="form-control" placeholder="mật khẩu">
        ...
        @if(isset($thatbai))
        <div>
          <center><font style="color:RED"><strong> Tên tài khoản hoặc mật khẩu sai. Vui lòng nhập lại!</strong></font></center>
        </div>
        @endif
        <br>
    ...
    <!-- iCheck -->
    <script src="public/source/ADMIN/plugins/iCheck/icheck.min.js"></script>
    <script>
      $(function () {
        $('input').iCheck({
